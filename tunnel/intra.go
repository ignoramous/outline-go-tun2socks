...
func NewIntraTunnel(fakedns string, dohdns doh.Transport, link stack.LinkEndpoint, dialer *net.Dialer, config *net.ListenConfig, listener IntraListener) (IntraTunnel, error) {
